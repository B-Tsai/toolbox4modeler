...
def sw_bthy_1d_inp(xb, zb, h0, x, outp_dir, file_name):
    """
    Generate a user-defined input file of 1D bathymetry for SWASH.
...
def cr_bthy_1d_inp(xb, zb, h0, x, outp_dir, file_name):
    """
    Generate a user-defined input file of 1D bathymetry for CROCO.
